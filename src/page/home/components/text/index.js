  ...
  render() {
    return (
      <div className={homeCss.text}>
        ...
        <span className={this.state.span2?homeCss.animate:''}>I'm Simon Wang</span><br/>
        <span className={this.state.span3?homeCss.animate:''}><strong>#Skr</strong><i className={this.state.cursor?homeCss.cursor:''}></i></span>
      </div>
    )
  }
}
